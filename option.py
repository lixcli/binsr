...
parser.add_argument('--binarize', default='approxsign', help='sign function')
...
parser.add_argument('--model_name',default='edsr',
                    help='set a EDSR model type: edsr|dorefa_edsr|pact_edsr|')
...
parser.add_argument('--dynamic_ratio', type=float, default=0.1,
                    help='The k_bits of the quantzie')
...
parser.add_argument('--w_l1', type=float, default=1.0,
                    help='learning rate')
parser.add_argument('--w_at', type=float, default=1000,
                    help='learning rate') 
...
parser.add_argument('--schedule', type=str, default='MultiStepLR')
