...
class _Residual_Block(nn.Module):
    def __init__(self):
        ...
        self.conv1 = bin_conv3x3(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1, bias=False)
        self.in1 = nn.BatchNorm2d(64, affine=True)
        self.relu = nn.Tanh()
        self.conv2 = bin_conv3x3(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1, bias=False)
